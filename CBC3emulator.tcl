...
#
# CBC3emulator.tcl: Tcl script for re-creating project 'CBC3emulator'
#
# Generated by Vivado on Fri Jan 13 11:29:52 CET 2017
...
#
# 1. This project restoration tcl script (CBC3emulator.tcl) that was generated.
#
# 2. The following source(s) files that were local or imported into the original project.
#    (Please see the '$orig_proj_dir' and '$origin_dir' variable setting below at the start of the script)
#
#    "/home/jluetic/CBC3/CBC3emulator.srcs/sources_1/imports/CBC3/user_package_basic.vhd"
#    "/home/jluetic/CBC3/CBC3emulator.srcs/sources_1/imports/CBC3/stub_data_output.vhd"
#    "/home/jluetic/CBC3/CBC3emulator.srcs/sources_1/imports/CBC3/phy_i2c_slave.vhd"
#    "/home/jluetic/CBC3/CBC3emulator.srcs/sources_1/imports/CBC3/fast_cmd.vhd"
#    "/home/jluetic/CBC3/CBC3emulator.srcs/sources_1/imports/test/trig_data.vhd"
#    "/home/jluetic/CBC3/CBC3emulator.srcs/sources_1/imports/CBC3/buffers.vhd"
#    "/home/jluetic/CBC3/CBC3emulator.srcs/sim_1/imports/CBC3/tb_top.vhd"
#
# 3. The following remote source files that were added to the original project:-
#
#    "/home/jluetic/CBC3/trig_data_pipeline.vhd"
#    "/home/jluetic/CBC3/generate_data.vhd"
#    "/home/jluetic/CBC3/buffer_fifo.vhd"
#    "/home/jluetic/CBC3/CBC3_top.vhd"
#
#*****************************************************************************************
...
set script_file "CBC3emulator.tcl"
...
# Create project
create_project CBC3emulator ./CBC3emulator -part xc7k70tfbv676-1
...
set obj [get_projects CBC3emulator]
set_property "board_part" "" $obj
set_property "compxlib.activehdl_compiled_library_dir" "$proj_dir/CBC3emulator.cache/compile_simlib/activehdl" $obj
set_property "compxlib.funcsim" "1" $obj
set_property "compxlib.ies_compiled_library_dir" "$proj_dir/CBC3emulator.cache/compile_simlib/ies" $obj
set_property "compxlib.modelsim_compiled_library_dir" "$proj_dir/CBC3emulator.cache/compile_simlib/modelsim" $obj
set_property "compxlib.overwrite_libs" "0" $obj
set_property "compxlib.questa_compiled_library_dir" "$proj_dir/CBC3emulator.cache/compile_simlib/questa" $obj
set_property "compxlib.riviera_compiled_library_dir" "$proj_dir/CBC3emulator.cache/compile_simlib/riviera" $obj
set_property "compxlib.timesim" "1" $obj
set_property "compxlib.vcs_compiled_library_dir" "$proj_dir/CBC3emulator.cache/compile_simlib/vcs" $obj
...
set_property "ip_output_repo" "/home/jluetic/CBC3/CBC3emulator.cache/ip" $obj
...
set files [list \
 "[file normalize "$origin_dir/trig_data_pipeline.vhd"]"\
 "[file normalize "$origin_dir/generate_data.vhd"]"\
 "[file normalize "$origin_dir/buffer_fifo.vhd"]"\
 "[file normalize "$origin_dir/CBC3_top.vhd"]"\
]
add_files -norecurse -fileset $obj $files

# Import local files from the original project
set files [list \
 "[file normalize "$origin_dir/CBC3emulator.srcs/sources_1/imports/CBC3/user_package_basic.vhd"]"\
 "[file normalize "$origin_dir/CBC3emulator.srcs/sources_1/imports/CBC3/stub_data_output.vhd"]"\
 "[file normalize "$origin_dir/CBC3emulator.srcs/sources_1/imports/CBC3/phy_i2c_slave.vhd"]"\
 "[file normalize "$origin_dir/CBC3emulator.srcs/sources_1/imports/CBC3/fast_cmd.vhd"]"\
 "[file normalize "$origin_dir/CBC3emulator.srcs/sources_1/imports/test/trig_data.vhd"]"\
 "[file normalize "$origin_dir/CBC3emulator.srcs/sources_1/imports/CBC3/buffers.vhd"]"\
]
set imported_files [import_files -fileset sources_1 $files]

# Set 'sources_1' fileset file properties for remote files
set file "$origin_dir/trig_data_pipeline.vhd"
...
set file "$origin_dir/generate_data.vhd"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property "file_type" "VHDL" $file_obj
set_property "is_enabled" "1" $file_obj
...
set file "$origin_dir/buffer_fifo.vhd"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property "file_type" "VHDL" $file_obj
set_property "is_enabled" "1" $file_obj
...
set file "$origin_dir/CBC3_top.vhd"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property "file_type" "VHDL" $file_obj
set_property "is_enabled" "1" $file_obj
...
set file "CBC3/user_package_basic.vhd"
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property "file_type" "VHDL" $file_obj
set_property "is_enabled" "1" $file_obj
set_property "is_global_include" "0" $file_obj
...
set file "CBC3/stub_data_output.vhd"
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property "file_type" "VHDL" $file_obj
set_property "is_enabled" "1" $file_obj
set_property "is_global_include" "0" $file_obj
...
set file "CBC3/phy_i2c_slave.vhd"
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property "file_type" "VHDL" $file_obj
set_property "is_enabled" "1" $file_obj
set_property "is_global_include" "0" $file_obj
...
# Import local files from the original project
set files [list \
 "[file normalize "$origin_dir/CBC3emulator.srcs/sim_1/imports/CBC3/tb_top.vhd"]"\
]
...
if {[string equal [get_runs -quiet synth_1] ""]} {
  create_run -name synth_1 -part xc7k70tfbv676-1 -flow {Vivado Synthesis 2016} -strategy "Vivado Synthesis Defaults" -constrset constrs_1
} else {
...
if {[string equal [get_runs -quiet impl_1] ""]} {
  create_run -name impl_1 -part xc7k70tfbv676-1 -flow {Vivado Implementation 2016} -strategy "Vivado Implementation Defaults" -constrset constrs_1 -parent_run synth_1
} else {
...
puts "INFO: Project created:CBC3emulator"
